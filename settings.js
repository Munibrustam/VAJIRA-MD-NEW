...
module.exports = {
SESSION_ID: process.env.SESSION_ID === undefined ? 'VAJIRA-MD=7dEU1RyA#d1QnqlHBDMBMGYL4D4YwmNZN9I-gf3exOiak2MaQFzE' : process.env.SESSION_ID,
...
FOOTER: process.env.FOOTER=== undefined ? '‌👨‍💻 Mr Kharos 👨‍💻': process.env.FOOTER,
